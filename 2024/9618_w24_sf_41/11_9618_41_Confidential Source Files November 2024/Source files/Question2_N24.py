...
for y in range(0,2):
    ...
    for x in range(0,4):
        ...
        print("The horse ", Horses[y].GetName() ," at fence ", x+1 ," has a ", Chance,"% chance of success")
        Total= Total+Chance
    Average= Total/4
    AverageSuccess.append(Average)
    print("The horse ", Horses[y].GetName() ,"has an average ", Average,"% chance of jumping over all four fences")  
